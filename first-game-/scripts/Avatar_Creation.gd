...
func _ready() -> void:
	...
	skin_textures = load_textures("res://assets/avatars/skin/")
	mouth_textures = load_textures("res://assets/avatars/mouth/")
	eyes_textures = load_textures("res://assets/avatars/eyes/")

	# Optional folders allow empty, with a "None" option
	hair_textures = [null] + load_textures("res://assets/avatars/hair/", true)
	accessories_textures = [null] + load_textures("res://assets/avatars/accessories/", true)
	outfit_textures = load_textures("res://assets/avatars/outfits/", true)
	fullsuit_textures = [null] + load_textures("res://assets/avatars/fullsuit/", true)
